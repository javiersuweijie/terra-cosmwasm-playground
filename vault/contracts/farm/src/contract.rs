...
pub fn execute(
    ...
    match msg {
        ...
        ExecuteMsg::Kill { position_id } => kill(deps, env, info, position_id),
    }
}
            ...
            .add_message(CosmosMsg::Wasm(
                ...
                WasmMsg::Execute {
                    ...
                    msg: to_binary(&Cw20ExecuteMsg::Send {
                        ...
                        contract: worker_addr.to_string(),
...
fn get_position_debt_ratio_bps(position: Position, debt_value: Uint256) -> StdResult<Uint128> {
    let equity_value = 
}
